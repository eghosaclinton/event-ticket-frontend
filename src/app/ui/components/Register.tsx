...
export default function Register() {
    ...
    function handleSubmit(e: FormEvent) {
        ...
        const { firstName, lastName, userMail, userPassword, userRole } =
            registerData
    ...
    return (
        <div className="fixed inset-0 overflow-y-auto p-4">
            <div className="flex min-h-full justify-center p-4 w-2/5 mx-auto my-0 rounded relative flex-col gap-5 bg-white">
                <Link href={'/'}>
                ...
                >
                    ...
                    <select
                        ...
                        className="w-3/5 p-2 border-black rounded-md border-[1.5px] focus:border-blue-400 focus:outline-0 focus:border-[1.5px]"
                    >
                    ...
                    <button className="bg-blue-400 text-white w-full rounded-md p-3">
                        Sign Up
                    </button>
                </form>
            </div>
